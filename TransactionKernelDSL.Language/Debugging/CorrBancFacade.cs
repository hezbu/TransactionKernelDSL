...
namespace PDS.Switch.CorrBanc
{
    ...
    /// <summary>
    /// The transactional facade for solution CorrBanc
    /// </summary>
    /// <remarks>
    /// Generated on 17/4/2016 11:19:15
    /// </remarks>
	public partial class CorrBancFacade : AbstractTransactionFacade
	{
        internal const string ConstStan = "ConstStan";

        private static CorrBancFacade _Instance = null;
        ...
        /// TRANSFORMACION
        /// </summary>
        public static CorrBancFacade Instance
        {
            get
            {
                if (_Instance == null)
                {
                    _Instance = new CorrBancFacade();
                }

                return _Instance as CorrBancFacade;
            }
        }
        ...
        private CorrBancFacade()
        {
            ...
            _IsTelnetLoggerOn = Convert.ToBoolean((GetValue("CorrBanc.General", "TelnetLoggerOn") as List<string>)[0]);
            _TelnetLogPort = 23100 + Convert.ToInt32(this._InstanceId);
            #endregion
            #region Logger
            this._LogDirectory = (GetValue("CorrBanc.General", "LogDirectory") as List<string>)[0];
            this._LogPrefix = (GetValue("CorrBanc.General", "LogPrefix") as List<string>)[0];
            #endregion
...
{ 
	...
	if (Int32.TryParse((GetValue("CorrBanc.General", "ListenerEngine_ServerTCPPort") as List<string>)[0], out intDefaultValue) == false) 
	intDefaultValue = 0; 
...
{ 
	...
	if (IPAddress.TryParse((GetValue("CorrBanc.General", "ListenerEngine_ServerIPAddress") as List<string>)[0], out defaultAddress) == false) 
...
{ 
	int intDefaultValue = 0;
	if (Int32.TryParse((GetValue("CorrBanc.General", "ListenerEngineServerTimeoutSec") as List<string>)[0], out intDefaultValue) == false) 
	intDefaultValue = 30; 
...
{ 
	int intDefaultValue = 0;
	if (Int32.TryParse((GetValue("CorrBanc.General", "ListenerEngineMinThread") as List<string>)[0], out intDefaultValue) == false) 
	intDefaultValue = 250; 
...
{ 
	int intDefaultValue = 0;
	if (Int32.TryParse((GetValue("CorrBanc.General", "ListenerEngineMaxCompletionWorkThread") as List<string>)[0], out intDefaultValue) == false) 
...
#region Web Services Setup 
            ...
            CorrBancFacadeUserCustomizedSetup();
            #endregion
  ...
  public override object SequenceFactory()
        ...
        public override bool StartEngines()
        {
            ...
            #region Start Log
            _Log.Info("## Service Launch CorrBanc - Instance Id = " + _InstanceId + " ##");
