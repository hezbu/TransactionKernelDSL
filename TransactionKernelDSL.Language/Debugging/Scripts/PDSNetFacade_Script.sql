	...
	GO
        		...
        		IF NOT EXISTS (SELECT cfg_instancia FROM CONFIGURACION WHERE cfg_seccion = 'PDSNet.General' and cfg_clave = 'TelnetLoggerOn' and cfg_instancia = 1) 
	BEGIN 
	...
	END 
	IF NOT EXISTS (SELECT cfg_instancia FROM CONFIGURACION WHERE cfg_seccion = 'PDSNet.General' and cfg_clave = 'LogDirectory' and cfg_instancia = 1) 
	BEGIN 
	INSERT INTO [CONFIGURACION] 
	  ([cfg_instancia] 
	  ,[cfg_seccion] 
	...
	END 
	IF NOT EXISTS (SELECT cfg_instancia FROM CONFIGURACION WHERE cfg_seccion = 'PDSNet.General' and cfg_clave = 'LogPrefix' and cfg_instancia = 1) 
	BEGIN 
	INSERT INTO [CONFIGURACION] 
	  ([cfg_instancia] 
	  ,[cfg_seccion] 
