...
namespace PDS.Switch.PDSNet
{
    ...
    /// </summary>
    /// <remarks>
    /// Generated on 06/05/2016 15:16:20
    /// </remarks>
	...
	{    
                                ...
                                public bool GetRequirement_UC()
                                {
                                    ...
                                    throw new NotImplementedException("Implementation left for GetRequirement_UC() in TL0_ListenerLayer_TransactionName1_Handler");
                                }
                                /// <summary>                   
                                ...
                                public bool BuildResponse_UC()
                                {
                                    ...
                                    throw new NotImplementedException("Implementation left for BuildResponse_UC() in TL0_ListenerLayer_TransactionName1_Handler");
                                }
                                ...
                                public bool Reply_UC()
                                {
                                    ...
                                    throw new NotImplementedException("Implementation left for Reply_UC() in TL0_ListenerLayer_TransactionName1_Handler");
                                }
                                 #endregion     
