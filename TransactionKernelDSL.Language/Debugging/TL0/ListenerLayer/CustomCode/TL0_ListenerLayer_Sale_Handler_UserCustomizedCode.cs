...
namespace PDS.Switch.PDSNet
{
	...
	{    
                                ...
                                public bool GetRequirement_UC()
                                {
                                    ...
                                    throw new NotImplementedException("Implementation left for GetRequirement_UC() in TL0_ListenerLayer_Sale_Handler");
                                }
                                /// <summary>                   
                                ...
                                public bool BuildResponse_UC()
                                {
                                    ...
                                    throw new NotImplementedException("Implementation left for BuildResponse_UC() in TL0_ListenerLayer_Sale_Handler");
                                }
                                ...
                                public bool Reply_UC()
                                {
                                    ...
                                    throw new NotImplementedException("Implementation left for Reply_UC() in TL0_ListenerLayer_Sale_Handler");
                                }
                                 #endregion     
