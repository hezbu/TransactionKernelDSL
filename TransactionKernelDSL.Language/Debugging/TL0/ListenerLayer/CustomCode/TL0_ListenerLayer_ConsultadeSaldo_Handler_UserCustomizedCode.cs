...
namespace PDS.Switch.CorrBanc
{
	...
	{    
                                ...
                                public bool GetRequirement_UC()
                                {
                                    ...
                                    throw new NotImplementedException("Implementation left for GetRequirement_UC() in TL0_ListenerLayer_ConsultadeSaldo_Handler");
                                }
                                /// <summary>                   
                                ...
                                public bool BuildResponse_UC()
                                {
                                    ...
                                    throw new NotImplementedException("Implementation left for BuildResponse_UC() in TL0_ListenerLayer_ConsultadeSaldo_Handler");
                                }
                                ...
                                public bool Reply_UC()
                                {
                                    ...
                                    throw new NotImplementedException("Implementation left for Reply_UC() in TL0_ListenerLayer_ConsultadeSaldo_Handler");
                                }
                                 #endregion     
