...
namespace PDS.Switch.PDSNet
{
	...
	{
         public  TL0_ListenerLayer_Sale_Handler()
            : base()
        {
            ...
            this.Logger = "MainLogger";
                _Context = new PDSNetContext();
                   _Context[PDSNetFacade.ConstStan] = PDSNetFacade.Instance.SequenceFactory() as string;
                    ...
                    {      
                        _Log.Error("Couldn't get sequence number for handler TL0_ListenerLayer_Sale_Handler ");
                    }
            ...
            this.ProcessTransactionMethod = new ProcessTransactionDelegate(ProcessTransaction);
                        ...
                        {
                            throw new NotImplementedException("Implementation left for GetRequirement() in TL0_ListenerLayer_Sale_Handler");
                        }
                        ...
                        {
                            throw new NotImplementedException("Implementation left for BuildResponse() in TL0_ListenerLayer_Sale_Handler");
                        }
...
return false; 
                        ...
                        {
                               throw new NotImplementedException("Implementation left for ForwardHandlerFactory() in TL0_ListenerLayer_Sale_Handler");
                        }
