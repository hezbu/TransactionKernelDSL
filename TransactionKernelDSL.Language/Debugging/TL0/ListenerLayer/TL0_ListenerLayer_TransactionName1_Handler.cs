...
namespace PDS.Switch.PDSNet
{
    ...
    /// <summary>
    /// A transaction handler named TransactionName1 with Id  1
    /// </summary>
    /// <remarks>
    /// Generated on 06/05/2016 15:16:54
    /// </remarks>
	public partial class TL0_ListenerLayer_TransactionName1_Handler: AbstractTransactionHandler,ITransactionHandlerListenable
	{
         public  TL0_ListenerLayer_TransactionName1_Handler()
            : base()
        {
            ...
            this.Logger = "MainLogger";
                _Context = new PDSNetContext();
                   _Context[PDSNetFacade.ConstStan] = PDSNetFacade.Instance.SequenceFactory() as string;
                    ...
                    {      
                        _Log.Error("Couldn't get sequence number for handler TL0_ListenerLayer_TransactionName1_Handler ");
                    }
                        ...
                        {
                            throw new NotImplementedException("Implementation left for GetRequirement() in TL0_ListenerLayer_TransactionName1_Handler");
                        }
                        ...
                        {
                            throw new NotImplementedException("Implementation left for BuildResponse() in TL0_ListenerLayer_TransactionName1_Handler");
                        }
