...
namespace PDS.Switch.PDSNet
{
	...
	{
         public  TL1_UniredLayer_Sale_Handler(AbstractTransactionContext context)
            : base(context)
        {
            ...
            this.ProcessTransactionMethod = new ProcessTransactionDelegate(ProcessTransaction_UC);
                     ...
                     #region ITransactionHandlerForwardable Members
                        ...
                        {               
                            throw new NotImplementedException("Implementation left for BuildRequirement() in TL1_UniredLayer_Sale_Handler");
                        } 
                        ...
                        public bool Resolve()
                        {
                            _Context.TransmissionStatus = TL1_UniredLayer_UniredEngine_Engine.Instance.Resolve(_AssignedParser);
                        ...
                        {
                             throw new NotImplementedException("Implementation left for GetResponse() in TL1_UniredLayer_Sale_Handler");
                        }
                        ...
                        {
                            throw new NotImplementedException("Implementation left for ProcessTransaction() in TL1_UniredLayer_Sale_Handler");
                        }
                    #endregion
