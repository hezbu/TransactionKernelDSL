...
namespace PDS.Switch.PDSNet
{
    ...
    /// <summary>
    /// A transaction handler named Balance Query with Id  S
    /// </summary>
    /// <remarks>
	...
	{
         public  TL1_UniredLayer_BalanceQuery_Handler(AbstractTransactionContext context)
            : base(context)
        {
            ...
            this.ProcessTransactionMethod = new ProcessTransactionDelegate(ProcessTransaction_UC);
                     ...
                     #region ITransactionHandlerForwardable Members
                        ...
                        {               
                            throw new NotImplementedException("Implementation left for BuildRequirement() in TL1_UniredLayer_BalanceQuery_Handler");
                        } 
                        ...
                        {
                             throw new NotImplementedException("Implementation left for GetResponse() in TL1_UniredLayer_BalanceQuery_Handler");
                        }
                        ...
                        {
                            throw new NotImplementedException("Implementation left for ProcessTransaction() in TL1_UniredLayer_BalanceQuery_Handler");
                        }
                    #endregion
