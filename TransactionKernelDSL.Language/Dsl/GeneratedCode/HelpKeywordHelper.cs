...
namespace TransactionKernelDSL.Framework.Language
{
	...
	/// </remarks>
	public partial class TrnxDslHelpKeywordHelper : TrnxDslHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new TrnxDslHelpKeywordHelper.
		/// </summary>
		protected TrnxDslHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the TrnxDslHelpKeywordHelper.
		/// </summary>
		public static TrnxDslHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class TrnxDslHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new TrnxDslHelpKeywordHelperBase.
		/// </summary>
		protected TrnxDslHelpKeywordHelperBase()
			: base() { }
