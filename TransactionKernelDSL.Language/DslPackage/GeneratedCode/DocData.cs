...
namespace TransactionKernelDSL.Framework.Language
{
	...
	/// </summary>
	internal partial class TrnxDslDocData : TrnxDslDocDataBase
	{
		/// <summary>
		/// Constructs a new TrnxDslDocData.
		/// </summary>
		public TrnxDslDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a TrnxDsl document in memory.
	/// </summary>
	internal abstract partial class TrnxDslDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new TrnxDslDocDataBase.
		/// </summary>
		protected TrnxDslDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::TransactionKernelDSL.Framework.Language.TrnxDslDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::TransactionKernelDSL.Framework.Language.TrnxDslDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(TrnxDslExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::TransactionKernelDSL.Framework.Language.TrnxDslDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::TransactionKernelDSL.Framework.Language.TrnxDslDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::TransactionKernelDSL.Framework.Language.TransactionModel modelRoot = null;
			...
			global::TransactionKernelDSL.Framework.Language.TrnxDslDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::TransactionKernelDSL.Framework.Language.TrnxDslSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, this.ValidationController, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::TransactionKernelDSL.Framework.Language.TrnxDslDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::TransactionKernelDSL.Framework.Language.TrnxDslDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::TransactionKernelDSL.Framework.Language.TransactionModel modelRoot = this.RootElement as global::TransactionKernelDSL.Framework.Language.TransactionModel;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::TransactionKernelDSL.Framework.Language.TrnxDslDiagram diagram = diagrams[0] as global::TransactionKernelDSL.Framework.Language.TrnxDslDiagram;
					if (diagram != null)
					{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::TransactionKernelDSL.Framework.Language.TransactionModel modelRoot = (global::TransactionKernelDSL.Framework.Language.TransactionModel)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::TransactionKernelDSL.Framework.Language.TrnxDslSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::TransactionKernelDSL.Framework.Language.TrnxDslSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::TransactionKernelDSL.Framework.Language.TrnxDslDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::TransactionKernelDSL.Framework.Language.TrnxDslSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::TransactionKernelDSL.Framework.Language.TrnxDslSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
