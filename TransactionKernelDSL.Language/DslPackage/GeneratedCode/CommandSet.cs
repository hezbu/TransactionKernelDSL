...
namespace TransactionKernelDSL.Framework.Language
{
	...
	/// </summary>
	internal partial class TrnxDslCommandSet : TrnxDslCommandSetBase
	{
		/// <summary>
		/// Constructs a new TrnxDslCommandSet.
		/// </summary>
		public TrnxDslCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class TrnxDslCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new TrnxDslCommandSetBase.
		/// </summary>
		protected TrnxDslCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewTrnxDslExplorerCommand,
				typeof(TrnxDslEditorFactory).GUID);
		...
		{
			TrnxDslExplorerToolWindow explorer = this.TrnxDslExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentTrnxDslDocData != null && this.CurrentTrnxDslDocData.Store != null)
			{
				this.CurrentTrnxDslDocData.ValidationController.Validate(this.CurrentTrnxDslDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentTrnxDslDocData != null && this.CurrentTrnxDslDocData.Store != null)
			{
				...
				this.CurrentTrnxDslDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected TrnxDslDocData CurrentTrnxDslDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as TrnxDslDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected TrnxDslDocView CurrentTrnxDslDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as TrnxDslDocView;
			}
		}
		...
		/// </summary>
		protected TrnxDslExplorerToolWindow TrnxDslExplorerToolWindow
		{
			get
			{
				TrnxDslExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(TrnxDslExplorerToolWindow), true) as TrnxDslExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				TrnxDslExplorerToolWindow explorerWindow = this.TrnxDslExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class TrnxDslClipboardCommandSet : TrnxDslClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new TrnxDslClipboardCommandSet.
		/// </summary>
		public TrnxDslClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class TrnxDslClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new TrnxDslClipboardCommandSetBase.
		/// </summary>
		protected TrnxDslClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
