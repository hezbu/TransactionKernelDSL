...
namespace TransactionKernelDSL.Framework.Language
{
	...
	/// </summary>
	internal partial class TrnxDslDocView : TrnxDslDocViewBase
	{
		/// <summary>
		/// Constructs a new TrnxDslDocView.
		/// </summary>
		public TrnxDslDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class TrnxDslDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new TrnxDslDocView.
		/// </summary>
		protected TrnxDslDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			TrnxDslDocDataBase docData = this.DocData as TrnxDslDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for TrnxDslDocViewBase should be an TrnxDslDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::TransactionKernelDSL.Framework.Language.TrnxDslDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::TransactionKernelDSL.Framework.Language.TrnxDslDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::TransactionKernelDSL.Framework.Language.TrnxDslToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::TransactionKernelDSL.Framework.Language.TrnxDslToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.TrnxDslDiagramMenu;
			}
		}
		...
		protected override void Initialize()
		{
			...
			if(helpService != null)
			{
				helpService.AddContextAttribute(string.Empty, "1", global::System.ComponentModel.Design.HelpKeywordType.F1Keyword);
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::TransactionKernelDSL.Framework.Language.TrnxDslHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::TransactionKernelDSL.Framework.Language.TrnxDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::TransactionKernelDSL.Framework.Language.TrnxDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
