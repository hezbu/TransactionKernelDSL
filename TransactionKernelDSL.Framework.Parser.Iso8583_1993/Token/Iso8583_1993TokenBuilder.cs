...
using TransactionKernelDSL.Framework.Parser.Iso8583_1993.Tokens._U1_EBT_AVAIL_BAL_TKN;

namespace TransactionKernelDSL.Framework.Parser.Iso8583_1993.Tokens
{
    public sealed class Iso8583_1993TokenBuilder
    {
        #region Fields
        private Iso8583_1993HeaderToken _TokenHeader = null;
        private List<Iso8583_1993AbstractToken> _Tokens = null;
        #endregion
        #region Properties
        public List<Iso8583_1993AbstractToken> Tokens
        {
            get
            {
                return _Tokens;
        ...
        public Iso8583_1993HeaderToken TokenHeader
        {
            get
            {
                return _TokenHeader;
        ...
        #region Constructors
        public Iso8583_1993TokenBuilder(string field63)
            : this()
        {
            _TokenHeader = new Iso8583_1993HeaderToken(field63);
            Debug.WriteLine("Iso8583_1993TokenBuilder, ctor: Raw Header -> " + _TokenHeader.ToString());
            Debug.WriteLine("Iso8583_1993TokenBuilder, ctor: Raw Tokens -> " + field63.Substring(_TokenHeader.ToString().Length));
            foreach (string rawToken in field63.Substring(_TokenHeader.ToString().Length).Split(new char[] { Iso8583_1993AbstractToken.EyeCatcher }))
            {
                if (String.IsNullOrEmpty(rawToken)) continue;
                string rawTokenWithEyeCatch = Iso8583_1993AbstractToken.EyeCatcher + rawToken;
        ...
        private Iso8583_1993TokenBuilder()
        {
            _Tokens = new List<Iso8583_1993AbstractToken>();
        }

        public Iso8583_1993TokenBuilder(List<Iso8583_1993AbstractToken> tokenList)
        {
            _Tokens = tokenList;
            _TokenHeader = new Iso8583_1993HeaderToken(_Tokens);
        }
        #endregion

        public void AddToken(Iso8583_1993AbstractToken newToken)
        {
            _Tokens.Add(newToken);
        }

        public void RemoveToken(Iso8583_1993AbstractToken tokenToRemove)
        {
        ...
        public override string ToString()
        {
            ...
            foreach (Iso8583_1993AbstractToken tok in _Tokens)
            {
