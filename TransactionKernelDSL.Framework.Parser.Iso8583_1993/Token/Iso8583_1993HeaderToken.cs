...
{
    public sealed class Iso8583_1993HeaderToken
    {
        ...
        private Iso8583_1993HeaderToken()
        {

        }

        public Iso8583_1993HeaderToken(List<Iso8583_1993AbstractToken> tokens)
        {
            int totalLength = 0;
            int totalCount = 1;

            foreach (Iso8583_1993AbstractToken token in tokens)
            {
        ...
        public Iso8583_1993HeaderToken(string rawTokens)
        {
