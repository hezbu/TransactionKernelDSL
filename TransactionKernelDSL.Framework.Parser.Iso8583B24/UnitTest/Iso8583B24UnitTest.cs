...
using TransactionKernelDSL.Framework.Parser.Iso8583B24.Tokens;
using System.Diagnostics;
using TransactionKernelDSL.Framework.Parser.Iso8583B24.Tokens._Q1_AUTH_MODE_ID_TKN;
using TransactionKernelDSL.Framework.Parser.Iso8583B24.Tokens._Q2_ACC_ID_TKN;
using TransactionKernelDSL.Framework.Parser.Iso8583B24.Tokens._Q6_PART_CHGS_TKN;

namespace TransactionKernelDSL.Framework.Parser.Iso8583B24.UnitTest
{
    [TestFixture]
    public class Iso8583B24UnitTest
    {
        [Test]
        public void Disassemble_Assemble_EDENRED_0200_002000_Test()
        {
            string _0200_002000_input = "ISO0260000100200B238C40128A1901A000000001000009C0020000000000007001122203258003652173258112211225411902011326036041212516707=12155010000000000000014371301563121        TERMINAL PRUEBA       DF           DF MX0275631213            00010001484FFFFFFFFFFFFFFFF016FDMSREG5+0000000019B044    00000000000078& 0000300078! 0400020                   Y ! C000026         06500             1150000000003020                    009163001001012P B24 B24 13038000000000000000                    000?";
            Iso8583B24Parser testObject = new Iso8583B24Parser();
            (testObject.RequestStream as Iso8583B24Stream).Set(_0200_002000_input);
            if (testObject.Disassemble() == false)
            {
                throw new AssertionException("Error en Dissasemble() -> " + testObject.ErrorMessage);
            }
            ...
            Assert.AreEqual(testObject.RequestStructure["PrimaryBitmap"].ToString(), "B238C40128A1901A");
            Assert.AreEqual(testObject.RequestStructure["1"].ToString(), "000000001000009C");
            ...
            Assert.AreEqual(_0200_002000_input, (testObject.ResponseStream as Iso8583B24Stream).ToString(false));

        }
        [Test]
        public void Disassemble_Assemble_EDENRED_0210_002000_Test()
        {
            string _0210_002000_input = "ISO0260000150210B23884012E81801A00000000140000DC002000000000000700112220343900365217325811221122902011326036123456786707=9876501000000000000001437133939630001563121        0275631213            00010001484016FDMSREG5+0000000019B044DES100100000000126& 0000400126! 0400020                   Y ! C000026         06500             ! U100038 1000000000000670042000000000000000000002440809919507020                  P0011    0000000009163001001012P9B24 B24 1303800000000000000053253082            000";
            Iso8583B24Parser testObject = new Iso8583B24Parser();
            (testObject.RequestStream as Iso8583B24Stream).Set(_0210_002000_input);
            ...
            Assert.AreEqual(testObject.RequestStructure["PrimaryBitmap"].ToString(), "B23884012E81801A");
            Assert.AreEqual(testObject.RequestStructure["1"].ToString(), "00000000140000DC");
            Assert.AreEqual(testObject.RequestStructure["3"].ToString(), "002000");
            Assert.AreEqual(testObject.RequestStructure["4"].ToString(), "000000000700");
            ...
            testObject.ResponseStructure = testObject.RequestStructure;
            Assert.AreEqual(true, testObject.Assemble());
            Assert.AreEqual(_0210_002000_input, (testObject.ResponseStream as Iso8583B24Stream).ToString(false));
        ...
        public void Disassemble_Assemble_EDENRED_0420_002000_Test()
        {
            ...
            Iso8583B24Parser testObject = new Iso8583B24Parser();
            (testObject.RequestStream as Iso8583B24Stream).Set(_0420_002000_input);
            Assert.AreEqual(true, testObject.Disassemble());

            Assert.AreEqual(testObject.RequestStructure["Base24Header"].ToString(), "026000010");
            Assert.AreEqual(testObject.RequestStructure["MessageType"].ToString(), "0420");
            Assert.AreEqual(testObject.RequestStructure["PrimaryBitmap"].ToString(), "B23A84012EA18018");
            Assert.AreEqual(testObject.RequestStructure["1"].ToString(), "00000040140001BC");
            Assert.AreEqual(testObject.RequestStructure["3"].ToString(), "002000");
            Assert.AreEqual(testObject.RequestStructure["4"].ToString(), "000000000700");
            ...
            testObject.ResponseStructure = testObject.RequestStructure;
            Assert.AreEqual(true, testObject.Assemble());
            Assert.AreEqual(_0420_002000_input, (testObject.ResponseStream as Iso8583B24Stream).ToString(false));
        ...
        public void Disassemble_Assemble_EDENRED_0430_002000_Test()
        {
            ...
            Iso8583B24Parser testObject = new Iso8583B24Parser();
            (testObject.RequestStream as Iso8583B24Stream).Set(_0430_002000_input);
            Assert.AreEqual(true, testObject.Disassemble());
            ...
            testObject.ResponseStructure = testObject.RequestStructure;
            Assert.AreEqual(true, testObject.Assemble());
            Assert.AreEqual(_0430_002000_input, (testObject.ResponseStream as Iso8583B24Stream).ToString(false));
        ...
        {
            Iso8583B24Parser testParser = new Iso8583B24Parser();
            //
        ...
        {
            Iso8583B24Parser testObject = new Iso8583B24Parser();
            Iso8583B24Structure testStructure = testObject.RequestStructure as Iso8583B24Structure;

            ((Iso8583B24Field)testStructure["Base24Header"]).CopyContentFrom("026000010");
            ((Iso8583B24Field)testStructure["MessageType"]).CopyContentFrom("0200");
            ((Iso8583B24Field)testStructure["PrimaryBitmap"]).CopyContentFrom("BABCC4A128E1C01E");
            ((Iso8583B24Field)testStructure["1"]).CopyContentFrom("0000000000000130");
            ((Iso8583B24Field)testStructure["3"]).CopyContentFrom("000030");
            ((Iso8583B24Field)testStructure["4"]).CopyContentFrom("000000002000");
            ((Iso8583B24Field)testStructure["5"]).CopyContentFrom("000000000580");
            ((Iso8583B24Field)testStructure["7"]).CopyContentFrom("0214071946");
            ((Iso8583B24Field)testStructure["9"]).CopyContentFrom("60289771");
            ((Iso8583B24Field)testStructure["11"]).CopyContentFrom("024153");
            ((Iso8583B24Field)testStructure["12"]).CopyContentFrom("041946");
            ((Iso8583B24Field)testStructure["13"]).CopyContentFrom("0214");
            ((Iso8583B24Field)testStructure["14"]).CopyContentFrom("0907");
            ((Iso8583B24Field)testStructure["17"]).CopyContentFrom("0214");
            ((Iso8583B24Field)testStructure["18"]).CopyContentFrom("5969");
            ((Iso8583B24Field)testStructure["22"]).CopyContentFrom("011");
            ((Iso8583B24Field)testStructure["25"]).CopyContentFrom("00");
            ((Iso8583B24Field)testStructure["27"]).CopyContentFrom("6");
            ((Iso8583B24Field)testStructure["32"]).CopyContentFrom("09903294010");
            ((Iso8583B24Field)testStructure["35"]).CopyContentFrom("215323690075364007=0907");
            ((Iso8583B24Field)testStructure["37"]).CopyContentFrom("000000039441");
            ((Iso8583B24Field)testStructure["41"]).CopyContentFrom("50901120        ");
            ((Iso8583B24Field)testStructure["42"]).CopyContentFrom("08557001        ");
            ((Iso8583B24Field)testStructure["43"]).CopyContentFrom("PERSONAL LIGHT        CAPITAL FEDER00 AR");
            ((Iso8583B24Field)testStructure["48"]).CopyContentFrom("02751824001           00060006");
            ((Iso8583B24Field)testStructure["49"]).CopyContentFrom("032");
            ((Iso8583B24Field)testStructure["50"]).CopyContentFrom("840");
            ((Iso8583B24Field)testStructure["60"]).CopyContentFrom("016PROPPRO2+0000000");
            ((Iso8583B24Field)testStructure["61"]).CopyContentFrom("019MCAR    03100000000");
            ((Iso8583B24Field)testStructure["62"]).CopyContentFrom("01001003     ");
            ((Iso8583B24Field)testStructure["63"]).CopyContentFrom("156& 0000500156! 0400020  00000000032      Y ! C000026 301     0000      00 1 00 ! C400012 000000000072! R200046 01    0                          T  0         ");
            ((Iso8583B24Field)testStructure["120"]).CopyContentFrom("029L N ALEM 1110 4TO PISO       ");
            ((Iso8583B24Field)testStructure["123"]).CopyContentFrom("02000000069160000000000");
            ((Iso8583B24Field)testStructure["124"]).CopyContentFrom("009009087001");
        ...
        public void TokenAssemble_Test()
        {
            try
            {
                ...
                Iso8583B24TokenBuilder test = new Iso8583B24TokenBuilder(new List<Iso8583B24AbstractToken> 
                    { 
                        _Q1_Token,
                        _Q2_Token,
                        _Q6_Token,
            ...
            {
                throw new AssertionException("Test falló: " + ex.Message);
            }
        ...
        public void TokenDisassemble_Test()
        {
            ...
            try
            {
                Iso8583B24TokenBuilder test = new Iso8583B24TokenBuilder(field63);
                Assert.AreEqual(test.ToString(), field63);
                test.Dump();
            }
            catch (Exception ex)
        ...
        public void TurnOffField_Test()
        {
            ...
            ((Iso8583B24Field)testStructure["PrimaryBitmap"]).CopyContentFrom("FFFFFFFFFFFFFFFF");
            ((Iso8583B24Field)testStructure["1"]).CopyContentFrom("FFFFFFFFFFFFFFFF");
